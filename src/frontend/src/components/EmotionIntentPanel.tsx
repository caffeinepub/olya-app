  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <Badge
          className={`text-xs ${SPEAKER_COLORS[latestEntry.speaker] ?? SPEAKER_COLORS.Unknown}`}
        >
          {latestEntry.speaker}
        </Badge>
      </div>
        ...
        <div className="space-y-2">
          {latestEntry.emotions.map((e: EmotionScore) => (
            <div key={e.emotionType} className="flex items-center gap-2">
              <span className="text-xs w-24 truncate capitalize">
                {e.emotionType}
              </span>
              ...
              .map((entry, idx) => (
                ...
                >
                  ...
                  <Badge
                    ...
                    className="text-xs shrink-0 capitalize"
                  >
                    {(entry.intents[0]?.intentType ?? "acknowledging").replace(
                      /-/g,
                      " ",
                    )}
                  </Badge>
